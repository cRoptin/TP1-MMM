    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        oBtnValid.setOnClickListener(new View.OnClickListener() {
            public void onClick(View poView) {
                ...
                Intent display = new Intent(MainActivity.this, SecondActivity.class);
                // Non parcelable
                /*display.putExtra("txtName", sName.getText().toString());
                display.putExtra("txtDate", dDate.getText().toString());
                display.putExtra("txtCity", sCity.getText().toString());*/

                // Parcelable
                ParcelableObj oParceObj = new ParcelableObj(sName.getText().toString(), dDate.getText().toString(), sCity.getText().toString());
                display.putExtra("parce", oParceObj);
